<x-owner-layout>
    <div class=" min-h-screen flex flex-col py-6 px-6">
        ...
        <a href="{{ route('vehicle.create') }}" <button type="button"
        ...
        @forelse ($vehicles as $vehicle)
            <div class="bg-white rounded-lg shadow-lg overflow-hidden w-fit p-5">
                <img src="{{ asset('storage/' . $vehicle->vehicle_img) }}" alt="Vehicle Image"
                ...
                <div class="p-4">
                    ...
                    <p class="text-sm text-gray-600">Vehicle Charge: ${{ number_format($vehicle->vehicle_charge, 2) }}
                    </p>
                </div>
